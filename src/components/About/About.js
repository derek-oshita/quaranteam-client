        ...
        <section className="about-main-container">
            <div className="about-table" id="about">
                ...
                <div className="post">
                    ...
                    <p>It's rough out there. Every state has handled the pandemic a little differently, so we encourage you to share your experience with other users so we can continue to stay safe and flatten the curve together.</p>
